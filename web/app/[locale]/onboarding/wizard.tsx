      ...
      return (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tell <code>fdh</code> where to read skills from. For Falabella,
              use the internal registry URL.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <CopyCommand command="fdh config set registry.url https://git.falabella.internal/skills/registry.git" />
            <p className="text-xs text-muted-foreground">
